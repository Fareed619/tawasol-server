...
router.post("/",
            ...
            async (req, res)=> {
                ...
                // client
                const {website, skills, youtube, twitter, instagram, github, facebook, ...rest } = req.body ;
                ...
                const socialFields = { youtube, twitter, instagram, facebook, github };

                for(let key in socialFields){
                    const value = socialFields[key];
                    if(value && value !== ""){
                        socialFields = normalize(value, {forceHttps: true});
...
router.put("/experience",
            ...
            check("from", "From is required and needs to be from the past").notEmpty()
            .custom((value, {req}) => {
